...
$.fn.mycity = function(pName, cName, aName) {
	...
	function showP(provinceList) {
		...
		for ( var i in provinceList) {
			...
			if (pName == provinceList[i].name) {
				...
				p.append("<option selected value='" + provinceList[i].name
						+ "'>" + provinceList[i].name + "</option>")
			} else {
				p.append("<option value='" + provinceList[i].name + "'>"
						+ provinceList[i].name + "</option>")
			}
		}
		if (!is_pName) {
	...
	function showC(cityList) {
		...
		for ( var i in cityList) {
			if (cName == cityList[i].name) {
				...
				c.append("<option selected value='" + cityList[i].name + "'>"
						+ cityList[i].name + "</option>")
			} else {
				c.append("<option value='" + cityList[i].name + "'>"
						+ cityList[i].name + "</option>")
			}
		}
	...
	function showA(areaList) {                   
		...
		for ( var i in areaList) {                                             
			...
			if (aName == areaList[i]) {
				a.append("<option selected value='" + areaList[i].name+","+areaList[i].code + "'>"
						+ areaList[i].name + "</option>")
			} else {                                                          
				a.append("<option value='" + areaList[i].name+","+areaList[i].code + "'>" + areaList[i].name
						+ "</option>")
			}
		}
	}
