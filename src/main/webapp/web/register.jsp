            ...
            <div style="float: right;width: 30%;background-color: #FFFFFF;height: 400px;margin-right: 200px;">
                <div style="margin:10px 30px;">
                    <div class="header">
                        ...
                        <span class="txt"><strong>会员注册</strong></span>
                        <span class="line"></span>
                    </div>
                    ...
                    <div style="height: 40px;border: 1px solid #efefef;margin: 15px 0px;">
                        <div style="margin: 1px 0px;">
                            ...
                            <input type="number" name="phonenum" class="phonenum" lay-verType="tips" lay-verify="phonenum" placeholder="请输入手机号码" style="vertical-align:middle;border: 0px;line-height: 35px;height: 35px;width:80%;border-left: 1px solid #efefef;margin-top: 2px;padding-left: 10px;">
                        </div>
                    </div>
                    <div style="height: 40px;;margin: 15px 0px;">
                        <div style="height: 40px;border: 1px solid #efefef;float: left;width: 72%">
                            <div style="margin: 1px 0px;">
                                ...
                                <input type="number" name="CheckCode" class="keyword"  lay-verType="tips" lay-verify="required" placeholder="请输入手机验证码" style="vertical-align:middle;border: 0px;line-height: 35px;height: 35px;width:80%;border-left: 1px solid #efefef;margin-top: 2px;padding-left: 10px;">
                            </div>
                        </div>
                    ...
                    <div style="height: 40px;border: 1px solid #efefef;margin: 15px 0px;">
                        <div style="margin: 1px 0px;">
                            <img src="${ctxRes}images/mm.png" style="margin-left:10px;margin-right:5px;vertical-align:middle;">
                            <input type="password" name="password" lay-verType="tips" lay-verify="password" placeholder="设置密码" style="vertical-align:middle;border: 0px;line-height: 35px;height: 35px;width:80%;border-left: 1px solid #efefef;margin-top: 2px;padding-left: 10px;">
                        </div>
                    </div>
                    <div style="height: 40px;border: 1px solid #efefef;margin: 15px 0px;">
                        <div style="margin: 1px 0px;">
                            <img src="${ctxRes}images/mm.png" style="margin-left:10px;margin-right:5px;vertical-align:middle;">
                            <input type="password" name="checkpassword" lay-verType="tips" lay-verify="checkpassword" placeholder="确认密码" style="vertical-align:middle;border: 0px;line-height: 35px;height: 35px;width:80%;border-left: 1px solid #efefef;margin-top: 2px;padding-left: 10px;">
                        </div>
                    </div>

                    <div style="height: 40px;margin: 15px 0px;text-align: center;">
                        <button id="register" class="layui-btn" lay-submit lay-filter="register" type="submit"  style="width: 100%;height: 38px;background-color: #2377cd;color:#FFFFFF;border: 0px;border-radius:2px;">马上注册</button>
                    </div>
                    </form>
                    <div style="text-align: center;color: #b2b2b2">
                        <a href="${ctx}userlogin.jsp" style="color: #b2b2b2"><span>已有账号?点击登录</span></a>
                    </div>
                </div>
            </div>
            <div class="clearDiv"></div>
    ...
    function register(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.status==1){
                    window.location.href = "${ctx}web/registerfinish.jsp";
                }else{
    ...
    //$("#register").on("click",function () {
        layui.use('form', function () {
            ...
            form.verify({
                ...
                phonenum: function(value, item){ //value：表单的值、item：表单的DOM对象
...
<script>
    ...
    $(function () {
        ...
        $("#btnSendCode").click(function () {
            $.ajax({
                type : "get",
                url : '${ctx}sendPhoneCheckCodeRegUser',
                data:{
                    phone:$(".phonenum").val()
