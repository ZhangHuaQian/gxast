        ...
        <div id="newslist_div" style="width:77%;float: left;background-color: #ffffff">
            <div id="newslist_area" style="margin-left: 10px;">
                <div id="newslist_header" style="color: GRAY;">
                    ...
                    </i>你当前位置 > <a href="${ctx }">首页</a> > <a href="${ctx }web/news/toNewsList">新闻中心</a> <a id="zhuti"></a> > ${news.title}</span>
                    </div>
                </div>
                        ...
                        <div class="layui-form layui-form-pane" accept-charset="utf-8">
                            <form  class="layui-form" id="main_form">
                                ...
                                <div class="layui-form-item" style="text-align: center">
                                    <button type="button" class="layui-btn layui-btn-normal" onclick="submitComment()" id="subBut" lay-filter="formDemo" lay-submit="submit"  >发表评论</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    var href="${ctx }web/news/toNewsList?pageNum=1&newTypeId="+zhuti;
