...
<div id="main"  style="margin-top: 0px" >
    ...
    <%--<c:forEach items="${list}" var="zxjj">--%>
    <%--action="${ctx}resaveController/go_resaveCount.do"--%>
    ...
    <div id="newslistdiv"  style="width:70%;min-width:1302px;margin: 10px auto;">
            ...
            <div id="newslist_area" style="margin-left: 10px;">
                <div id="newslist_header" style="color: GRAY;">
                    <div style="padding-top: 8px;padding-bottom: 10px;border-bottom: 2px solid #E8E8E8;margin-right: 10px;">
                        <img src=""><span>你当前位置 > <a href="${ctx }">首页</a> > 中心简介</span>
                    </div>
                </div>
                <div id="newstitle"  style="margin-top: 30px;text-align: center;">
                   <h1 id="title"  style="margin-top: 30px;text-align: center;">${zxjj.title}</h1>
                    <div><p id="bq"></p></div>
                    <h3 id="createTime"  style="margin-top: 10px;color: #9c9c9c"><fmt:formatDate value="${zxjj.createTime}" pattern="yyyy年MM月dd日"/></h3>
                </div>
                <div id="newslist" style="margin-top: 30px;" >
                    <div id="details"  style="margin-right: 10px;color: #404040;font-size: 16px;line-height: 2">${zxjj.content}</div>
        ...
        <%--</c:forEach>--%>
        <%--var d=new Date(zxjj.createTime).format("yyyy-MM-dd");--%>
