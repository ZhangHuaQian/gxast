        ...
        <div id="newslist_div" style="width:77%;float: left;background-color: #ffffff">
            <div id="newslist_area" style="margin-left: 10px;">
                <div id="newslist_header" style="color: GRAY;">
                    ...
                    </i>你当前位置 > <a href="${ctx }">首页</a> > <a href="${ctx }web/news_axhd/selectList">党建工作</a> <a id="zhuti"></a> > ${news.title}</span>
                    </div>
                </div>
                    ...
                    <div class="fly-panel detail-box" id="flyReply">
                        ...
                        <div class="layui-form layui-form-pane">
                            ...
                            <div class="layui-form-item" style="text-align: center">
                                    ...
                                    <button onclick="submitComment()"  class="layui-btn layui-btn-normal" id="subBut" lay-filter="formDemo" lay-submit="submit" >发表评论</button>
                ...
                <ul>
                    <div style="background-color:#2377cd;color:#FFFFFF;border-bottom: 2px solid #f2f5f9;padding-top: 8px;padding-bottom: 8px;">
                        <div style="margin-left: 10px;">
                            ...
                            <span style="margin-left: 2px;">党建工作</span>
                        </div>
            ...
            <%--<div style="background-color: #FFFFFF;margin-top: 20px;font-size: 15px">--%>
                ...
                <%--<div>--%>
                    <%--<div style="margin: 10px 10px;padding-bottom: 10px;">--%>
                        <%--&lt;%&ndash;<img src="${ctxRes}images/zt00.png" style="width: 100%;">--%>
                        <%--<img src="${ctxRes}images/zt01.png" style="margin-top: 10px;width: 100%;">&ndash;%&gt;--%>
...
<script>
    ...
    var href="${ctx }web/news_axhd/selectList?pageNum=1&newTypeId="+zhuti;
    if(zhuti.indexOf("88") !=-1){
        $("#zhuti").html(">党建工作");
        $("#zhuti").attr("href",href);
    }else if(zhuti.indexOf("89") !=-1){
        $("#zhuti").html(">党建生活")
        $("#zhuti").attr("href",href);
    }else{
        $("#zhuti").hide();
    ...
    function detailid_find(){
        $(".find").click(function () {
            window.location.href='${ctx}web/news_axhd/selectList?pageNum='+1+'&newTypeId='+$(this).attr("detailid");
        })
    }
   ...
   /* function com_even_bind(){
        $(".commentsBtn").click(function () {
            ...
            layer.open({
                ...
                type:2,
                area: ['400px', '300px'],
                content:'${ctx}web/news_axhd/insert.jsp?comid='+$(this).attr("comid"),
                title:'信息',
...
<script type="text/javascript">
    ...
    function submitComment() {
        ...
        if(commentValue.length > 0){
            $.ajax({
                type : "POST",
                url : '${ctx}web/news_axhd/commitcomment.do?topic_type=djgz',
                data:{id:${news.id},
    ...
    function comment(){
        ...
        $.ajax({
            type : "POST",
            url : "${ctx}web/news_axhd/comment.do?id=${news.id}&topic_type=djgz",
            error : function(data) {
                layer.msg('网络异常');
            },
            success : function(data) {
    ...
    function comment_two() {
        ...
        $.ajax({
            type : "POST",
            url : "${ctx}web/news_axhd/comment_two.do?id=${news.id}&topic_type=djgz",
            error : function(data) {
                layer.msg('网络异常');
            },
            success : function(data) {
...
<script>
    $(function () {
        ...
        $("#like").click(function () {
            ...
            $.ajax({
                type : "POST",
                url : "${ctx}web/news_axhd/insert?id=${news.id}&news_type=djgz",
                error : function(data) {
                    alert("网络异常 ！");
                },
                success : function(data) {
                    ...
                    if(data==2){
                        ...
                        $("#span").html(data.news_axhd.praise_view);
                    }
    ...
    function select() {
        ...
        $.ajax({
            type : "POST",
            url : "${ctx}web/news_axhd/select?id=${news.id}&news_type=djgz",
            error : function(data) {
            },
            success : function(data) {
                console.log(data);
