...
<form class="layui-form layui-form-pane" id="main_form" style="">
    ...
    <div style="float: left;padding: 10px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input lay-filter="testFilter" name="smaster" id="testFilter" lay-search="" autocomplete="off" class="layui-input" ts-selected="testFilter"></input>
            </div>
       ...
       <%-- <div class="layui-form-item">
            <label class="layui-form-label">发帖数量</label>
            <div class="layui-input-inline">
                <input type="number" name="stopiccount" lay-verify="required" placeholder="发帖数量"
                       autocomplete="off" class="layui-input">
            </div>
            <label class="layui-form-label">点击率</label>
            <div class="layui-input-inline">
                <input type="text" name="sclickcount" lay-verify="required" placeholder="点击率" autocomplete="off"
                       class="layui-input">
            </div>
        </div>--%>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn layui-btn layui-btn-normal" lay-submit lay-filter="formDemo">添加版块</button>
