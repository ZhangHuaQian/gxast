...
<form class="layui-form " id="main_form" method="post" enctype="multipart/form-data">
    ...
    <div style="float: left;padding: 10px;width:95%">
           ...
           <div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>收件人</label>
		...
		<div class="layui-form-item" id="mycity">
			<label class="layui-form-label"><span class="red">* </span>地区选择</label>
		...
		<div class="layui-form-item layui-form-text" >
            ...
            <div class="layui-input-block">
                <button class="layui-btn layui-btn-warm" lay-submit lay-filter="formDemo" id="btnUpdate">更新信息</button>
        ...
        function initAddress() {
            $.ajax({
                ...
                success: function (result) {
					...
					var p=result.address.province;
					var c=result.address.city;
					var a=result.address.area;
                        $('#mycity').mycity(p,c,a);
