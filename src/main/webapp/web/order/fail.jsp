...
<div class="bg" style="margin-top: 10px;margin-bottom: 100px ">
		...
		<div id="app" style="margin: 13px;">
			<el-breadcrumb separator-class="el-icon-arrow-right">
				<el-breadcrumb-item> <i class="layui-icon">&#xe68e;
					...
					href="${ctx }/web/product/home">商城首页<i class="layui-icon" style="margin-left: 5px;color: #c0c4cc">&#xe602;</i></a></el-breadcrumb-item> <el-breadcrumb-item>支付失败</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
	</div>
	...
	<div style="border: 1px solid #e8e8e8; padding: 10px;height: 50px;">
		<div style="float: left;padding-left: 10px;">
			<i class="layui-icon" style="font-size: 40px;color: #e06f5b;">&#x1007;</i>
		</div>
