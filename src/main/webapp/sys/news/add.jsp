 ...
 <%@ include file="/commViews/head.jsp"%>
  ...
  <div class="layui-form-item">
   	...
   	<div class="layui-input-block">
    	 	<input type="text" name="title" id="title"  required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input" maxlength="40">
   	</div>
  </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="editor" id="editor" readonly placeholder="编辑" value='${sessionScope.USER_SESSION_NAME.name}' autocomplete="off" class="layui-input" >
      </div>
  ...
  <div class="layui-form-item" id="recommend_img" style="display: none">
    ...
    <div style="display: none">
      ...
      <input type="text" id="recommendContent" name="recommendContent" class="layui-input" >
    </div>
  </div>
  <div class="layui-form-item">
