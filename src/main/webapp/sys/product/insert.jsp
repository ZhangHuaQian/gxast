...
<body>
	...
	<form class="layui-form layui-form-pane" id="main_form" style="">
		...
		<div style="padding: 10px;">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>商品描述 </label>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="isUp" value="1" title="是" checked>
					<input type="radio" name="isUp" value="0" title="否">
				</div>
			</div>
			<label class="layui-form-label"><span class="red">* </span>添加型号</label>
			...
			<!--显示图片-->
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>封面图片 </label>
				<div class="layui-input-inline"
					style="margin-right: 0px; width: 40%">
					<input type="hidden" id="image" class="layui-input" name="image"
						placeholder="图片路径" lay-verify="image" autocomplete="off"
						style="display: none" />
				</div>                           
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button type="button" class="layui-btn layui-btn layui-btn-normal"
						lay-submit lay-filter="formDemo">添加商品信息</button>
				</div>
			</div>
