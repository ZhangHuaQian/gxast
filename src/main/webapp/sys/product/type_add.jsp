...
<body>
	...
	<form class="layui-form layui-form-pane" id="main_form" style="">
		...
		<div style="padding: 10px;">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>型号名称</label>
				<div class="layui-input-inline">
					<input type="text" id="name" lay-verify="required" maxlength="10"
						placeholder="型号名称" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>型号价格</label>
				<div class="layui-input-inline">  
					<input  id="price" lay-verify="required" type="number" maxlength="6"
						placeholder="型号价格" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>型号重量</label>
				<div class="layui-input-inline">  
					<input  id="weight" lay-verify="required" type="number" maxlength="3"
						placeholder="型号重量 KG" autocomplete="off" class="layui-input">
				</div>
			</div>                         
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>型号库存</label>
				<div class="layui-input-inline">  
					<input  id="stock" lay-verify="required" type="number" maxlength="6"
						placeholder="型号库存" autocomplete="off" class="layui-input" onkeyup="NumberCheck(this)">
				</div>
			</div>
			<!--显示图片-->
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="red">* </span>型号图片 </label>
				<div class="layui-input-inline"
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<div class="layui-btn layui-btn layui-btn-normal" onclick="send()">添加型号</div>     
				</div>
			</div>
	...
	<script type="text/javascript">   
		...
		function send(){                          
			...
			var param = {id_:parent.id,name:$("#name").val(),stock:$("#stock").val(),image:$("#image").val(),price:$("#price").val(),weight:$("#weight").val()};
			console.log(param);       
			parent.JsonData(param);                    
			layer.msg("添加成功");
			setTimeout( function(){   
