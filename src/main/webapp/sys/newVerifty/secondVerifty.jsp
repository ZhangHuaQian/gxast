...
<form class="layui-form" id="main_form" method="post" style="padding-top: 50px;max-width: 677px;margin-left: auto;margin-right: auto;">
  <div class="layui-form-item">
    <input type="hidden" name="id" value="${news.id}">
    <input type="hidden" name="nvuId" value="${newsVeriftyUser.uuid}">
    <label class="layui-form-label">作者：</label>
    <div class="layui-input-inline">
      <input type="text" disabled class="layui-input lm-disable-layui-input" value="${news.author}">
    </div>
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">一审意见：</label>
    <div class="layui-input-block">
      <div style="padding: 9px 0px">
        ${newsVeriftyUser.remark}
      </div>

    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">二审结果：</label>
    <div class="layui-input-block">
      <input type="radio" name="verifty" value="5" title="通过" checked="">
      <input type="radio" name="verifty" value="6" title="退回">
    </div>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">二审批注：</label>
    <div class="layui-input-block">
...
<script>
    ...
    function sendData(){
        ...
        $.ajax({
            type:'post',
            url:'${ctx }newsVerifty/secondVerifty',
            data:fromDate,
            async:false,
    ...
    function closeWindow() {
        if(window.parent.frames["资讯二审"]!=undefined)window.parent.frames["资讯二审"].location.reload();// 刷新父窗口
        setTimeout(function (){
