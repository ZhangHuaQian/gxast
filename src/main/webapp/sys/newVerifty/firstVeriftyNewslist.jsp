...
<script>
    ...
    function getInitData(pageNum) {
        ...
        $.ajax({
            type : 'post',
            //url : '${ctx }sys/news/selectMyFirstVeriftyList?'+parseParam(obj),
            url : '${ctx }newsVeriftyUser/selectMyFirstVeriftyList',
            ...
            table.on('tool(tableDataFilter)', function(obj) {
                ...
                if (layEvent === 'verifty') { //编辑
                    ...
                    showWin({
                        ...
                        type : 2,
                        title : '审核资讯',
                        url : '${ctx}newsVerifty/toFirstVerifty?'+parseParam(params)
                    });
