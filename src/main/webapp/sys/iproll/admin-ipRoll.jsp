...
<%--<form class="layui-form layui-form-pane" onsubmit="return false" id="main_form" style="">--%>
    <blockquote class="layui-elem-quote" style="padding:10px;margin-bottom:0px;">
       <%-- <div class="layui-input-inline">
        ...
        <button class="layui-btn layui-btn-normal" onclick="insertUserShow()"><i class="layui-icon">&#xe608;</i>添加IP地址
        </button> 
...
<script>
	...
	function getUserData(pageNum) {
		...
		console.log('${ctx }sys/iproll/selectList?pageNum=' + pageNum+  '&ipaddress=' + ipaddress);
		$.ajax({
			type : 'get',
			url : '${ctx }sys/iproll/selectList?pageNum=' + pageNum +'&ipaddress='+ipaddress,
			dataType : 'json',
			success : function(result) {
				console.log(result);
				if(result.count > 0){
