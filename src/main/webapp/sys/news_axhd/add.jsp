...
function initNewsType(){
	$.ajax({
		type: 'get',
        url: '${ctx }sys/dictionary/selectList?type=type_axhd',
...
function closeWindow() {
	if($(window.parent.frames["党建工作"]).length>0){
		window.parent.frames["党建工作"].location.reload() ;// 刷新父窗口
