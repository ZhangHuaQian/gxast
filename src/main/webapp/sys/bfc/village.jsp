		...
		<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number"
						...
						name="totalHouseholds" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="totalPopulation" lay-verify="required"
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="poorPopulation" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 90px">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="lowInsured" lay-verify="required"
				...
				<div class="layui-input-inline" style="width: 90px">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="lowInsuredPopulation" lay-verify="required"
				...
				<div class="layui-input-inline" style="width: 90px">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="fiveInsured" lay-verify="required"
				...
				<div class="layui-input-inline" style="width: 90px">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="fiveInsuredPopulation" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="disabled" lay-verify="required" value="${village.disabled }"
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="poorHouseholds" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="laborForcePopulation" lay-verify="required"
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="nonLabourForcePopulation" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="perCapitaIncome" lay-verify="required"
				...
				<div class="layui-input-inline">
					<input type="number"
						oninput="if(value.length>10)value=value.slice(0,10)"
						name="enrolment" lay-verify="required"
