 ...
 <%@ include file="/commViews/head.jsp"%>
  ...
  <div class="layui-form-item" id="recommend_img" style="display: none">
    ...
    <div style="display: none">
      <input type="text" name="recommendImg" class="layui-input" >
...
function closeWindow() {
	if($(window.parent.frames["小博士报"]).length>0){
  ...
  layui.use([ 'upload' ], function() {
    ...
    var imgurl = upload.render({
      ...
      url: '${ctx}base/uploadfile', //上传接口
        ...
        console.log(res)
        recomend_img = res.data.src
        $('#preview').css('display','').attr('src',recomend_img)
        $('#recommend_img').find('input[name="recommendImg"]').val(recomend_img)
