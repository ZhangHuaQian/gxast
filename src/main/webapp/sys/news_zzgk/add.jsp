 ...
 <%@ include file="/commViews/head.jsp"%>
  ...
  <div class="layui-form-item">
   	...
   	<div class="layui-input-block">
    	 	<input type="text" name="title" maxlength="40" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
   	</div>
  </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="editor" readonly id="editor" placeholder="编辑" value='${sessionScope.USER_SESSION_NAME.name}' autocomplete="off" class="layui-input" >
      </div>
  ...
  <div class="layui-form-item">
   	...
   	<div class="layui-input-block">
    	 	<input type="text" name="description" maxlength="200" required  lay-verify="required" placeholder="文章描述" autocomplete="off" class="layui-input">
   	</div>
  </div>
  <div class="layui-form-item layui-form-text" style="display: none;">
    <label class="layui-form-label">正文</label>
    <div class="layui-input-block">
      <textarea name="content" placeholder="请输入内容" class="layui-textarea" id="contentTEXT" lay-verify="required" name="content"></textarea>
    </div>
  </div>
...
function initNewsType(){
	$.ajax({
		type: 'get',
        url: '${ctx }sys/dictionary/selectList?type=type_zzgk',
...
function closeWindow() {
	if($(window.parent.frames["政务公开"]).length>0){
		window.parent.frames["政务公开"].location.reload() ;// 刷新父窗口
