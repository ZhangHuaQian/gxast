...
<body>
	...
	<script type="text/html" id="barDemo">
		...
		<%--<button class="layui-btn layui-btn-xs layui-btn-warm " lay-event="updateStatus"><i class="layui-icon"></i> 处理</button>--%>
...
<script>
    ...
    $(function() {
		...
		function getUserData(pageNum) {
			...
			$.ajax({
				type : 'get',
				url : '${ctx}report/selectListunreport?pageNum=' + pageNum
    ...
    function closeWindow() {
        ...
        reload_parent('sys/topic/undoreportList.jsp');
        setTimeout(function (){
            var index = parent.layer.getFrameIndex(window.name); //先得到当前iframe层的索引
