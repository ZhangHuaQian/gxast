...
<form class="layui-form layui-form-pane" id="main_form" style="">
    ...
    <div style="float: left;padding: 10px;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <div class="layui-unselect layui-form-select layui-form-selected">
                    <div class="layui-select-title">
                        <input type="text" placeholder="点击选择部门" id="selectTreeBut" value="" disabled
            ...
            <div class="layui-input-inline">
                <input type="text" name="loginname" lay-verify="required" placeholder="如:手机或邮箱" readonly
                       autocomplete="off"
                       class="layui-input">
            </div>
...
<script>
    ...
    function reloadParentWin() {
        if(window.parent.frames["管理员管理"]!=undefined)window.parent.frames["管理员管理"].location.reload();// 刷新父窗口
