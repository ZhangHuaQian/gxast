package com.cen.web.new_axhd.controller;
 ...
 */
@Controller
@RequestMapping("/web/news_axhd")
public class WebNews_axhdController extends BaseController {
    ...
    public String selectList(NewsAxhd news, @RequestParam(value="pageNum",defaultValue="1",required=false) Integer pageNum,Integer newTypeId, HttpServletRequest request,
        ...
        return "/web/news_axhd/selectList";
    }
    ...
    public String details(@PathVariable Integer id, HttpServletRequest request,
        ...
        news_axhdService.updateByPrimaryKeySelective(news2);
        return "/web/news_axhd/details";
    }
    ...
    public String webdetails(@PathVariable Integer id, HttpServletRequest request,
        ...
        news2.setPage_view(news.getPage_view()+1);
        news_axhdService.updateByPrimaryKeySelective(news2);
        return "/web/news_axhd/webdetails";
    }
