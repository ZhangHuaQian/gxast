package com.cen.address.controller;
...
public class addressController extends BaseController {
	...
	@ResponseBody
	public String selectList(String userid, int pageNum, HttpServletRequest request, HttpServletResponse response,
			ModelMap map) {
	...
	@ResponseBody
	public String selectList(HttpServletRequest request, HttpServletResponse response, ModelMap map) {
	...
	@ResponseBody
	public String getuserAddress(String userid, HttpServletRequest request, HttpServletResponse response,
			ModelMap map) {
	...
	@ResponseBody
	public String cancelState(Address address, HttpServletRequest request, HttpServletResponse response) {
		Map<String, Object> umap = new HashMap<String, Object>();
		address.setState(0); // 0-非默认地址，1-默认地址
	...
	@ResponseBody
	public String update(String id, Address address, HttpServletRequest request, HttpServletResponse response,
			ModelMap map) {
		Map<String, Object> umap = new HashMap<String, Object>();
		address.setId(id);
		address.setAddress(address.getProvince() + address.getCity() + address.getArea());
