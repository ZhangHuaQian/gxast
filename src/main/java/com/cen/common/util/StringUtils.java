...
public class StringUtils {
    ...
    private  static  final String SESSION_KEY="captche";
    /**
    ...
    /**
     * 判断对象或对象数组中每一个对象是否为空: 对象为null返回true，字符序列长度为0，集合类、Map为empty
     *
     * @param obj
     * @return
     */
    ...
    //验证码校验
    public static boolean ver(String str, HttpServletRequest request){
        if(str!=null&& !str.trim().isEmpty()){
           String captcha=(String) request.getSession().getAttribute(SESSION_KEY);
           return str.trim().toLowerCase().equals(captcha);
        }
        return false;
    }
