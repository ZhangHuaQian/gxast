...
public class ConfigUtil {
    ...
    public static final String APPID="wxd87e11112721e484"; // 小博士报公众号
    public static final String APP_SECRET="057be37b8c3268393bd3b01334ef7a5c";
    public static final String GRANT_TYPE="client_credential";
    public static final String JSAPI_TICKET_TYPE="jsapi";
    public static final String ACCESS_TOKEN_URL="https://api.weixin.qq.com/cgi-bin/token";//获取token接口（Get）
    public static final String JSAPI_TICKET_URL="https://api.weixin.qq.com/cgi-bin/ticket/getticket";//获取jsapi_ticket接口
    public static final String CURRENT_URL="";//调用接口页面
    public static String ACCESS_TOKEN="";   //全局缓存access_token
    public static String JSAPI_TICKET="";   //全局缓存jsapi_ticket
