...
public class LogInterceptor extends HandlerInterceptorAdapter {
    ...
    private StringBuilder getRequestInfo(HttpServletRequest request) {
        ...
        reqInfo.append(" 来源IP=" + HttpUtil.getIpAddr(request)); 


        String userName = "";
        /*try {
            SysUserEntity sysUser = (SysUserEntity) SecurityUtils.getSubject().getSession().getAttribute(ReturnInfoType.USER_SESSION_NAME);
            if (sysUser != null) {
